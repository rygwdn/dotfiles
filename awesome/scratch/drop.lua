...
function toggle(prog, vert, horiz, width, height, sticky, screen)
    ...
    local attach_signal = capi.client.connect_signal    or capi.client.connect_signal
    local detach_signal = capi.client.disconnect_signal or capi.client.disconnect_signal
