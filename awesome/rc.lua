...
awful.rules.rules = {
    ...
    { rule = { class = "SMPlayer" },
      properties = { floating = true } },
    { rule = { instance = "python", name = "Confirm Launch" },
      properties = { floating = true, sticky = true, ontop = true, focus = true } },
    { rule = { instance = "gnome-settings-daemon" },
      properties = { floating = true, sticky = true, ontop = true } },
    { rule = { instance = "gnome-control-center" },
      properties = { floating = true, sticky = true, ontop = true } },
