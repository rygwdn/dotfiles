function fish_title
    ...
    set -l path_display
    if set -q STARSHIP_PATH_PREFIX; and set -q STARSHIP_PATH_NORMAL
        # Combine prefix and normal segments for a clean shortened path
        set path_display "$STARSHIP_PATH_PREFIX$STARSHIP_PATH_NORMAL"
    else
